...
namespace JustChat.Application.Models.Specifications.Base
{
        ...
        where T : class
    {
        ...
        public virtual OrderedSpecification<T> ApplyOrderBy(Expression<Func<T, object>> orderByExpression)
        {
            OrderBy = new OrderBy<T>(OrderType.Asc, orderByExpression);
            return new OrderedSpecification<T>(this);
        }

        public virtual OrderedSpecification<T> ApplyOrderByDescending(Expression<Func<T, object>> orderByDescendingExpression)
        {
